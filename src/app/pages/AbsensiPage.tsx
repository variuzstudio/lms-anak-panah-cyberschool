...
export default function AbsensiPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-['Inter',sans-serif]">ABSENSI</h1>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-['Inter',sans-serif] text-lg">PERSENTASE KEHADIRAN</h3>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
        <div className="p-6 border-b border-white/[0.06]">
          <h3 className="font-['Inter',sans-serif] text-lg">RIWAYAT ABSENSI</h3>
        </div>
