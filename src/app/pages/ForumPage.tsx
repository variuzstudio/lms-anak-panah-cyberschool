  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-['Inter',sans-serif]">FORUM & EVENT</h1>
      ...
      <div className="flex gap-3 overflow-x-auto pb-2">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-['Inter',sans-serif] text-sm transition-all whitespace-nowrap ${
          ...
          filteredPosts.map((post) => (
            <div key={post.id} className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
              <div className="p-6">
                ...
                {/* Post Content */}
                <h3 className="text-xl font-['Inter',sans-serif] mb-3">{post.title}</h3>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg max-w-2xl w-full">
            <div className="p-6 border-b border-white/[0.06]">
              <h2 className="text-xl font-['Inter',sans-serif]">BUAT POSTINGAN BARU</h2>
            </div>

            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Kategori</label>
                <select
              ...
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Judul</label>
                <input
                  type="text"
                  value={newPost.title}
              ...
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Konten</label>
                <textarea
