  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-['Inter',sans-serif]">MANAJEMEN GURU</h1>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="bg-white/[0.03] border-white/[0.06] text-white">
            <DialogHeader>
              <DialogTitle className="font-['Inter',sans-serif]">Tambah Guru Baru</DialogTitle>
            </DialogHeader>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-transparent border-b border-white/[0.06]">
              <tr>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">NIP</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Nama</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Mata Pelajaran</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Kontak</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Kelas</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Status</th>
                <th className="px-6 py-4 text-left text-sm font-['Inter',sans-serif]">Aksi</th>
              </tr>
            </thead>
            <tbody>
