...
export default function LaporanPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-['Inter',sans-serif]">LAPORAN</h1>
      ...
      {/* Report List */}
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
        <h3 className="font-['Inter',sans-serif] text-lg mb-4">LAPORAN TERSEDIA</h3>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
        <h3 className="font-['Inter',sans-serif] text-lg mb-4">PERFORMA AKADEMIK</h3>
