  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-['Acumin_Variable_Concept',sans-serif]">MATA PELAJARAN</h1>
          ...
          <div key={subject.id} className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6 hover:border-[#1aff00] transition-all cursor-pointer">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-['Acumin_Variable_Concept',sans-serif] text-lg">{subject.name}</h3>
