  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-['Acumin_Variable_Concept',sans-serif]">DATA SISWA</h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/[0.04]">
              <tr>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">NIS</th>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">NAMA</th>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">KELAS</th>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">EMAIL</th>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">TELEPON</th>
                <th className="px-6 py-4 text-left font-['Acumin_Variable_Concept',sans-serif] text-sm">ORANG TUA</th>
