  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-['Inter',sans-serif]">NILAI & RAPOR</h1>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
        <div className="p-6 border-b border-white/[0.06]">
          <h3 className="font-['Inter',sans-serif] text-lg">DAFTAR NILAI</h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/[0.04]">
              <tr>
                <th className="px-6 py-4 text-left font-['Inter',sans-serif] text-sm">MATA PELAJARAN</th>
                <th className="px-6 py-4 text-center font-['Inter',sans-serif] text-sm">TUGAS</th>
                <th className="px-6 py-4 text-center font-['Inter',sans-serif] text-sm">UTS</th>
                <th className="px-6 py-4 text-center font-['Inter',sans-serif] text-sm">UAS</th>
                <th className="px-6 py-4 text-center font-['Inter',sans-serif] text-sm">NILAI AKHIR</th>
                <th className="px-6 py-4 text-center font-['Inter',sans-serif] text-sm">HURUF</th>
              </tr>
            </thead>
      ...
      {/* Grade Legend */}
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
        <h3 className="font-['Inter',sans-serif] text-sm mb-4">KETERANGAN NILAI</h3>
