...
export default function PembayaranPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-['Orbitron',sans-serif]">PEMBAYARAN SPP</h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/[0.04]">
              <tr>
                {user?.role === 'admin' && (
                  <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">SISWA</th>
                )}
                <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">BULAN</th>
                <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">TAHUN</th>
                <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">JUMLAH</th>
                <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">STATUS</th>
                <th className="px-6 py-4 text-left font-['Orbitron',sans-serif] text-sm">METODE</th>
                  ...
                  <tr key={payment.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {payment.status === 'paid' ? (
                        ...
                        <button
                          className="flex items-center gap-2 px-4 py-2 bg-[#00aeff] hover:bg-[#00aeff]/80 rounded-lg transition-all text-sm font-['Orbitron',sans-serif]"
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-white/[0.06]">
              <h2 className="text-xl font-['Orbitron',sans-serif]">PILIH METODE PEMBAYARAN</h2>
            ...
            <div className="p-6 space-y-4">
              {/* Bank Transfer */}
              <div>
                <h3 className="text-sm font-['Orbitron',sans-serif] mb-3 flex items-center gap-2">
                  <Building2 size={16} />
                  TRANSFER BANK
                </h3>
            ...
            <div className="p-6 border-t border-white/[0.06] flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2 bg-[#00aeff] hover:bg-[#00aeff]/80 rounded-lg font-['Orbitron',sans-serif] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                BAYAR SEKARANG
              </button>
            </div>
