...
export default function PengaturanPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-['Acumin_Variable_Concept',sans-serif]">PENGATURAN</h1>
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-['Acumin_Variable_Concept',sans-serif] text-lg">PROFIL</h3>
          </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-['Acumin_Variable_Concept',sans-serif] text-lg">KEAMANAN</h3>
          </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-['Acumin_Variable_Concept',sans-serif] text-lg">NOTIFIKASI</h3>
          </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-['Acumin_Variable_Concept',sans-serif] text-lg">TAMPILAN</h3>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
