  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-['Inter',sans-serif]">TUGAS</h1>
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-['Inter',sans-serif] mb-1">{assignment.title}</h3>
                  ...
                  <div className="flex gap-2">
                    {user?.role === 'murid' && !mySubmission && (
                      <button
                        ...
                        className="bg-[#00aeff] hover:bg-[#00aeff]/80 text-white px-4 py-2 rounded-lg text-sm font-['Inter',sans-serif] flex items-center gap-2 transition-all"
                      >
                        <Upload size={16} />
                        KUMPULKAN
                      </button>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg max-w-2xl w-full">
            <div className="p-6 border-b border-white/[0.06]">
              <h2 className="text-xl font-['Inter',sans-serif]">BUAT TUGAS BARU</h2>
            </div>

            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Judul Tugas</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Deskripsi</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-['Inter',sans-serif] mb-2">Mata Pelajaran</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-['Inter',sans-serif] mb-2">Kelas</label>
                  <select
              ...
              <div>
                <label className="block text-sm font-['Inter',sans-serif] mb-2">Deadline</label>
                <input
                  type="datetime-local"
            ...
            <div className="p-6 border-t border-white/[0.06] flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2 bg-[#00aeff] hover:bg-[#00aeff]/80 rounded-lg font-['Inter',sans-serif] transition-all"
              >
                BUAT TUGAS
              </button>
            </div>
